...
if __name__ == "__main__":
    ...
    FINAL_MODEL_PATH = os.path.join(MODELS_DIR, "accident_detection_weighted_cnn_model.pth")
    CHECKPOINT_PATH = os.path.join(LOGS_DIR, "weighted_training_checkpoint.pth")
